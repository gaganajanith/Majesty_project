...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 08, 2026 at 07:04 PM
...
CREATE TABLE `users` (
  ...
  `password` varchar(225) NOT NULL COMMENT 'password',
...
(1, 'admin', 'admin@majesty.com', 'admin', 123456, 'admin', 'admin'),
(2, 'user', 'user@majesty.com', 'user', 123456, 'user', 'user');
